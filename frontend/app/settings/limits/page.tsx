    ...
    <>
      <header className="flex h-16 shrink-0 items-center gap-2 border-b border-foreground/[0.05]">
        <div className="flex items-center gap-2 px-4">
          ...
          <span className="text-sm font-medium text-foreground/90">Settings / Usage & Limits</span>
        </div>
      </header>
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 p-8 pt-10">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-foreground/90">Usage & limits</h1>
